...
# ╔═╡ ffaf4740-36c6-11f0-2b48-b7753e3e75ad
using Symbolics

# ╔═╡ 9903da17-7991-402c-a3a2-5b841dce60b2
md"""
# 剛体変換のノートブック
"""

# ╔═╡ 1833f012-2bce-44ca-bdb5-205729e78673
begin
	@variables Q11 Q12 Q13
	@variables Q21 Q22 Q23
	...
	@variables R11 R12 R13
	@variables R21 R22 R23
	@variables R31 R32 R33
	R = [
		R11 R12 R13
		R21 R22 R23
		R31 R32 R33
	...
	@variables S11 S12 S13
	@variables S21 S22 S23
	@variables S31 S32 S33
	S = [
		S11 S12 S13
		S21 S22 S23
		S31 S32 S33
...
# ╔═╡ ddd041af-72ad-4997-a644-9d34b8958dbd
begin
	@variables s1 s2 s3
	s = [s1, s2, s3]
	@variables t1 t2 t3
...
# ╔═╡ 8c8cd227-3991-47a3-afa0-003126f14cb7
begin
	G0 = [
		Q11 Q12 Q13 s1
		Q21 Q22 Q23 s2
...
# ╔═╡ 205a56c8-3561-4758-ae59-0fb4e7bdcff2
G1 * G2

# ╔═╡ 3b5e6706-4b1e-4b2a-a715-3af1cfb1700f


# ╔═╡ aeb81921-ad63-44a3-8394-c4d3091b1488
G12 = [
	 R * S t + R * u
	 0 0 0 1
]

# ╔═╡ bf7d3175-18a6-49f0-9c61-dddc5a75d601
# 演算規則
@assert G12 - G1 * G2 |> iszero

# ╔═╡ 592ee0f2-c20a-423d-b756-58194366c71a
# 結合律が満たされる
@assert (G0 * G1) * G2 - G0 * (G1 * G2) .|> simplify |> iszero

# ╔═╡ ab582073-6a8e-4c72-80c1-04f1c191dc57
# 逆元が具体的に記述できる
@assert G1_inv = [
	inv(R) -inv(R)*t
	0 0 0 1
] - inv(G1) .|> simplify |> iszero
...
manifest_format = "2.0"
project_hash = "422026062aa14077582ac7082e000f852234677f"
